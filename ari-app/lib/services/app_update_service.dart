...
class AppUpdateService {
  ...
  Future<AppUpdateInfo?> checkForUpdate() async {
    if (kUpdateFeedUrl.trim().isEmpty) {
      return null;
    }

    final uri = Uri.tryParse(kUpdateFeedUrl);
    if (uri == null) {
      return null;
    }
    ...
    try {
      ...
      final latestVersion =
          platformMetadata['latestVersion']?.toString().trim().isNotEmpty ==
              true
      ...
      return AppUpdateInfo(
        ...
        windowsUrl: _readPlatformDownloadUrl(
          uri,
          'windows',
          decoded,
          downloads,
  ...
  Future<void> openDownloadUrl(AppUpdateInfo info) async {
