...
class AvatarProvider extends ChangeNotifier {
  ...
  List<AgentInfo> get allAvatars => _repository.getAllAgents();

  AgentInfo get currentAvatar => _repository.getAgent(_currentAgentId);
  ...
  Future<void> createAndSwitchAvatar(String id, String newName) async {
    final newAgent = AgentInfo(id: id, name: newName, imagePath: '');
